...
var tween2 = new gsap.to("#thinkingMan", { opacity: 0, x: -1, delay: -0.5 });

var tween3 = new gsap.to("#disLogo", { opacity: 1, delay: -0.2 });

var tween4 = new gsap.to("#disInfo", { opacity: 1, y: -30, delay: -0.4 });
